...
# Ross's exact Small Account Rules
PER_TRADE_RISK_DOLLARS = 50.0          # Rule 1
DAILY_LOSS_LIMIT = -100.0              # Rule 2
MAX_CONSECUTIVE_LOSERS = 3             # Rule 3
...
def get_current_price(symbol):
    """Use bid price for stops (conservative)"""
    try:
...
def main():
    print("🚀 Warrior Trading Risk Manager started\n")
    while True:
        try:
            run_risk_manager()
        except Exception as e:
